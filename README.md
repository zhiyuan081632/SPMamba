...
conda env create -f spmamba_env.yml
...
To test the SMMamba model， run the following command:
```bash
# test with libri2mix datasets
python audio_test.py --conf_dir=configs/spmamba-librimix.yml

# test with echo2mix datasets
python audio_test.py --conf_dir=configs/spmamba-echo2mix.yml
```
